...
//This is for JOB FORM
    ...
    input_name.style.height = '30px';
    input_name.style.borderRadius = '3px';
    ...
    input_city.style.borderRadius = '3px';
    ...
    input_state.style.height = '30px';
    input_state.style.borderRadius = '3px';
    ...
    input_country.style.height = '30px';
    input_country.style.borderRadius = '3px';
    ...
    input_salary.style.height = '30px';
    input_salary.style.borderRadius = '3px';
    ...
    input_skills.style.height = '30px';
    input_skills.style.borderRadius = '3px';
    ...
    input_experience.style.height = '30px';
    input_experience.style.borderRadius = '3px';
    ...
    input_starting_date.style.height = '30px';
    input_starting_date.style.borderRadius = '3px';
    ...
    input_current_status.style.height = '30px';
    input_current_status.style.borderRadius = '3px';
...
//This is ELECTRONIC FORM
    ...
    input_model_name.style.height = '30px';
    input_model_name.style.borderRadius = '3px';
    ...
    input_condition.style.height = '30px';
    input_condition.style.borderRadius = '3px';
    ...
    input_storage.style.height = '30px';
    input_storage.style.borderRadius = '3px';
    ...
    input_color.style.height = '30px';
    input_color.style.borderRadius = '3px';
    ...
    input_quantity.style.height = '30px';
    input_quantity.style.borderRadius = '3px';
    ...
    input_describe_elec .style.borderRadius = '3px';
    ...
    input_name_real.style.height = '30px';
    input_name_real.style.borderRadius = '3px';
    ...
    input_city_real.style.height = '30px';
    input_city_real.style.borderRadius = '3px';
    ...
    input_state_real.style.height = '30px';
    input_state_real.style.borderRadius = '3px';
    ...
    input_country_real.style.height = '30px';
    input_country_real.style.borderRadius = '3px';
    ...
    input_postalcode.style.height = '30px';
    input_postalcode.style.borderRadius = '3px';
    ...
    input_describe_real .style.borderRadius = '3px';
    ...
    input_expected_rent.style.height = '30px';
    input_expected_rent.style.borderRadius = '3px';
    ...
    input_expected_lease.style.height = '30px';
    input_expected_lease.style.borderRadius = '3px';
...
//  function getJobsForm(clicked_id)
//  {

//     var mainFormDiv = document.getElementById('all3forms').innerHTML;
//     mainFormDiv.style.display = "flex";
//     mainFormDiv.style.justifyContent = "space-around";

//     var divForInsideForm = document.createElement('div');
//     divForInsideForm.style.display = "flex";
//     divForInsideForm.id = "liveDiv";
...
//     var temporarydivjob = document.createElement('div');
//     temporarydivjob.id = "tempDivjob";
    
//     mainFormDiv.appendChild(divForInsideForm);
//     divForInsideForm.appendChild(form);

//     form.appendChild(temporarydivjob);
...
//     temporarydivjob.appendChild(input_name);
//     form.appendChild(br.cloneNode())

    
//     //  if(clicked_id == "btnjob")
//     //  {
//     //     var mainFormDiv = document.getElementById('all3forms').innerHTML;
//     // mainFormDiv.style.display = "flex";
//     // mainFormDiv.style.justifyContent = "space-around";
...
//     // var input_describe = document.createElement("textarea");
//     // input_describe.setAttribute('name','description');
//     // input_describe.name = "post";
//     // input_describe.maxLength = "5000";
//     // input_describe.cols = "20";
//     // input_describe.rows = "10";
//     // input_describe.style.width = '300px';
//     // input_describe.style.height = '30px';
//     // input_describe.style.borderRadius = '3px';
//     // input_describe.style.marginBottom = '10px';
//     // input_describe.placeholder = "Enter Somegthing About Job";

//     // form.appendChild(input_describe);
//     // form.appendChild(br.cloneNode());
...
//     // var input_skills = document.createElement("input");
//     // input_skills.setAttribute('type',"text");
//     // input_skills.setAttribute('name',"skills");
//     // input_skills.style.width = '300px';
//     // input_skills.style.height = '30px';
//     // input_skills.style.borderRadius = '3px';
//     // input_skills.style.marginBottom = '10px';
//     // input_skills.placeholder = "Enter Your Skills";
...
//     //  }
//     //  else if(clicked_id == "btnelectronic")
//     //  {
//     //     var mainFormDiv = document.getElementById('all3forms');
//     // mainFormDiv.style.display = "flex";
//     // mainFormDiv.style.justifyContent = "space-around";
